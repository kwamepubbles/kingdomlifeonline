...
<section>
    <div class="container-fluid mt-4">
        <div class="row justify-content-center pb-5">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 inner p-2">
                <a href="#!"><img src="img/sots.jpg" class="d-block w-50 h-auto m-auto p-3" alt="..."></a>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 inner p-2 m-auto">
...
<section>
    <div class="container-fluid ">
        <div class="row justify-content-center pt-4">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 p-2 m-auto" style="font-size: 200px; color:blueviolet;">
                <p class="text-center d-block w-50 h-auto m-auto p-3"><i class="fa-solid fa-scroll"></i></p>
            </div>
