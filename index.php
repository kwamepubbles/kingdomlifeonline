...
<section>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg col-md col-sm about">
                <h2 class="font-weight-bold text-center mx-auto "> Welcome to Kingdom Life</h2>
                <div class="col inner p-3 mb-3">
                    <p class="mx-auto">
            ...
            <div class="col-lg col-md col-sm">
                <div class="row justify-content-center">
                    <img class="d-block w-60 h-auto" src="img/klm-HD.png" alt="...">
                </div>
            </div>
        </div>
    </div>
