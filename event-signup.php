                ...
                <form class="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="$_POST">
                    <div class="row p-5 event-area text-center">
                        ...
                        <div class="col-sm-12 col-md-4 mb-3 form-floating">
                            ...
                            <label for="floatingSelect" class="px-5">Sex</label>
                        </div>
                        <div class="col-sm-12 col-md-4 mb-3 form-floating">
                            ...
                            <label for="floatingSelect" class="px-5">Number of People</label>
                        </div>
                        ...
                        <label for="floatingTextarea" class="px-5">Any special needs...?</label>
                        </div>
