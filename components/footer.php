...
<footer>
  ...
  <div class="container-fluid text-white">
    <!--Grid row-->
    <div class="row justify-content-center pt-2 ms-3 me-3">
      <!--Grid column-->
      ...
      <div class="col-lg col-md text-center">
        ...
        <h6 class="text-uppercase mb-0">Media </h6>
      ...
      <div class="col-lg col-md text-center">
        ...
        <h6 class="text-uppercase mb-0 text-left">Contact </h6>
        <ul class="list-unstyled">
      ...
      <div class="social">
        <nav class="navbar shadow">
          <ul class="navbar col-sm-8 pt-1 ms-4 me-4">
            ...
            <li class="nav-item"><a href="#" role="button" class="nav-link"><i class="fas fa-home"></i></a></li>
